...
class Student(Model):
    ...
    """
    def __init__(self, student_id: float=None, first_name: str=None, last_name: str=None, grade_records: GradeRecord=None):  # noqa: E501
        ...
        :type grade_records: GradeRecord
        """
        self.swagger_types = {
            'student_id': float,
            'first_name': str,
    ...
    @property
    def grade_records(self) -> GradeRecord:
    ...
    def grade_records(self, grade_records: GradeRecord):
